...
const SuccessModal: React.FC<SuccessModalProps> = ({ isOpen, onClose, message, vCart }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-pink-400 p-6 rounded-lg shadow-lg w-full max-w-md relative">
                <button
                    onClick={onClose}
                ...
                <div className="flex items-center bg-gray-400 border border-gray-200 text-gray-700 p-4 rounded-md mb-4">
                    <svg className="w-6 h-6 mr-3 flex-shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
