    ...
    <footer className="bg-black text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-2xl font-bold">Elegant Finds Shop</h3>
            <p className="mt-4 text-gray-400">
            Discover unbeatable deals and exclusive products at Elegant Finds Shop. Shop with confidence, backed by exceptional customer support!
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-6 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} Elegant Finds Shop. All rights reserved by S@im@.</p>
        </div>
      </div>
    </footer>
  );
